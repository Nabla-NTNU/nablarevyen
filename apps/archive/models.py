...
class Image(models.Model):
    ...
    description = models.TextField(max_length=200, help_text="Short description of the image, 200 symbols.")
    image = models.ImageField(upload_to='archive/images/', help_text="To crop the image, simply click save and continue.")
...
class Video(models.Model):
    archive = models.ForeignKey('Archive', on_delete=models.CASCADE)
    alt = models.CharField(max_length=50)
    description = models.TextField(max_length=200, help_text="Short description of the video, 200 symbols.")
